...
DATA
```{r}
placebo_dt <- readRDS("data/placebo_dt_mar.rds")
load("data/W")
rownames(W) <- NULL
```
...
saveRDS(forest_fit, "data/forest_fit_mar.rds")
```
...
print(t1 - t0)
mex_fit$method <- "mex"
saveRDS(mex_fit, "data/mex_fit_mar0.rds")
```
...
saveRDS(arx_fit, "data/arx_fit_mar0.rds")
```
...
saveRDS(spx_fit, "data/spx_fit_mar0.rds")
```
...
saveRDS(twfe_fit, "data/twfe_fit_mar.rds")
...
saveRDS(etwfe_fit, "data/etwfe_fit_mar.rds")
```
